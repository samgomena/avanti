          ...
          <div className="container">
            <div className="row">
              <div className="col">
                ...
                <p>
                  On August 21, 2018, a lifelong dream of chef/owner Mark
                  Carruth and his soulmate Jeanne Schneider became a reality at
                  the corner of Nyberg and Martinazzi in Tualatin, Oregon. After
                  spending most of their lives working in corporate restaurants,
                  this talented and personable couple launched a small, unique,
                ...
                <ul>
                  ...
                  <br />
                  <li>
                    A relaxing atmosphere for lunch, happy hour, and dinner,
                    where Mark and Jeanne take pride in visiting with and
